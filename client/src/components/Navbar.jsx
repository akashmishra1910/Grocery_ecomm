...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-indigo-200 relative transition-all">

          <Link to={"/"}>
          <h1 className="text-4xl font-bold text-indigo-500 cursor-pointer">GroceryIt</h1>
          </Link>
           ...
           <Link to={"/products"}>All Products</Link>
                ...
                <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-800 px-3 rounded-full">
                    <input
                    onChange={(e)=>setSearchQuery(e.target.value)}
                     className="py-1.5 w-full bg-transparent outline-none placeholder-gray-600" type="text" placeholder="Search products" />
